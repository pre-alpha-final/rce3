...
public class MudslideOptionsTests
{
    ...
    public void ArgumentsOverrideEnvironmentVariables()
    {
        ...
        var succeeded = MudslideOptions.TryCreate(
    ...
    public void MissingArgumentsFallBackIndependently()
    {
        ...
        Assert.True(MudslideOptions.TryCreate([], environment, out var environmentOptions, out var firstProblem), firstProblem);
        ...
        Assert.True(MudslideOptions.TryCreate([ArgumentFeed], environment, out var mixedOptions, out var secondProblem), secondProblem);
    ...
    {
        Assert.False(MudslideOptions.TryCreate([feed], _ => null, out var options, out var problem));
        Assert.Null(options);
    ...
    {
        Assert.False(MudslideOptions.TryCreate(
    ...
    private static Func<string, string?> EnvironmentValues(string feed, string authorization)
    {
        ...
        {
            MudslideOptions.FeedEnvironmentVariable => feed,
            MudslideOptions.AuthorizationEnvironmentVariable => authorization,
            _ => null
        };
    }
}
